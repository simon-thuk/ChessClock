...
//   let options = ["3 min", "5 min", "10 min", "5 min + 5 sec", "10 min + 5 sec"]


//                    Section(header: Text("Time")) {
//                        List {
//                            ForEach(timeInSeconds, id: \.self) { option in
//
//                                HStack {
//                                    Text(TimeFormat.timeForSettings(option))
//                                    Spacer()
//                                    if TimeFormat.timeForSettings(option) == selectedOption {
...
//                                .onTapGesture {
//                                    self.selectedOption = TimeFormat.timeForSettings(option)
//                                }
//                            }
//                        }
//                    }
